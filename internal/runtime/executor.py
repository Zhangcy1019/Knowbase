...
from internal.models import AgentRun, RunStep, SkillExecutionContext, SkillInvocation, SkillResult, SkillSpec, ToolCall, ToolResult
...
class RuntimeExecutor:
    """Execute tools and skills while persisting step-level audit data."""
